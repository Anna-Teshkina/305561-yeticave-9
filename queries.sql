...
(name, img_key) VALUES ('Доски и лыжи','boards'), ('Крепления','attachment'), ('Ботинки','boots'), ('Одежда','clothing'), ('Инструменты ','tools'), ('Разное','other');
...
INSERT INTO lot
(name, category_id, price_start, img, date_start, date_end) VALUES
    ('2014 Rossignol District Snowboard','1','10999','img/lot-1.jpg','2019-01-01','2019-09-01'),
    ('DC Ply Mens 2016/2017 Snowboard','1','159999','img/lot-2.jpg','2019-02-01','2019-04-20'),
    ('Крепления Union Contact Pro 2015 года размер L/XL','2','8000','img/lot-3.jpg','2019-03-12','2019-04-13'),
    ('Ботинки для сноуборда DC Mutiny Charocal','3','10999','img/lot-4.jpg','2019-04-15','2019-10-05'),
    ('Куртка для сноуборда DC Mutiny Charocal','4','7500','img/lot-5.jpg','2019-02-25','2019-06-02'),
    ('Маска Oakley Canopy','6','5400','img/lot-6.jpg','2019-02-25','2019-06-02');
...
WHERE CURRENT_TIMESTAMP < lot.date_end ORDER BY lot.date_start DESC LIMIT 20;
...
WHERE lot.id = '3'
ORDER BY bet.date DESC LIMIT 20;
